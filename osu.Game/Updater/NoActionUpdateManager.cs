    ...
    public partial class NoActionUpdateManager : UpdateManager
    {
        ...
        protected override async Task<bool> PerformUpdateCheck(CancellationToken cancellationToken)
        {
            try
            {
                ...
                OsuJsonWebRequest<GitHubRelease[]> releasesRequest = new OsuJsonWebRequest<GitHubRelease[]>("https://api.github.com/repos/Rekiln/lazer/releases?per_page=10&page=1");
